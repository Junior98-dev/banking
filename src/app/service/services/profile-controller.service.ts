...
export class ProfileControllerService extends BaseService {
  ...
  static readonly Descriptor111Path = '/profile/accounts';
  ...
  static readonly Descriptor113Path = '/profile/contacts';
  ...
  static readonly Descriptor115Path = '/profile/transactions';
